...
import { gmapsMap, gmapsCircle, gmapsRectangle, GmBounds, GmPosition } from 'v3-gmaps';
...
const circleOptions: Ref<CircleOptions> = ref({
...
const rectangleOptions: Ref<RectangleOptions> = ref({
	bounds: {
		east: 145,
		north: -20,
		west: 132,
...
const handleCircleChange = (e: GmPosition | null) => log(`Circle moved to: ${e?.lat.toFixed(2)}, ${e?.lng.toFixed(2)}`);
const handleRectangleChange = (e: GmBounds | null) =>
	log(
