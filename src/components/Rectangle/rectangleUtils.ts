/**
 * Creates and returns a complete options object for a rectangle by combining base options with component props
 * @param baseOptions Initial options object (like map instance)
 * @param props The component props containing rectangle properties
 * @returns A new options object with all properties resolved
 */
export function resolveRectangleOptions(
