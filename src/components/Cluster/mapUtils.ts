 ...
 */
export const getExpandedBounds = (map: google.maps.Map): google.maps.LatLngBoundsLiteral => {
 ...
 */
export const zoomToPosition = (map: google.maps.Map, position: google.maps.LatLngLiteral): void => {
	// Zoom in 1 level
